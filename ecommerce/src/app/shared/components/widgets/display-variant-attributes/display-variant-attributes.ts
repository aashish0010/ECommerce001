...
@Component({
  ...
  imports: [CurrencySymbolPipe, TranslateModule, Button, NgClass],
  templateUrl: './display-variant-attributes.html',
  styleUrl: './display-variant-attributes.scss',
})
export class DisplayVariantAttributes {
