...
var AuthState = class AuthState2 {
  ...
  refreshTokenSuccess(ctx, action) {
    ctx.patchState({
...
], AuthState.prototype, "refreshTokenSuccess", null);
__decorate([
  Selector()
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AuthState, [{
    type: Injectable
  }], null, { register: [], login: [], loginWithNumber: [], forgotPassword: [], sendEmailOtp: [], verifyEmailOtp: [], verifyEmail: [], verifyNumber: [], updatePassword: [], logout: [], authClear: [], refreshTokenSuccess: [] });
})();

export {
  AuthState
};
//# sourceMappingURL=chunk-N7GM3VJ6.js.map
