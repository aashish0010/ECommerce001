...
import "./chunk-LPQEB73E.js";
import {
  GetThemesAction,
  ThemeState
} from "./chunk-F2SHJLLN.js";
import {
  BlogState
...
var content = [
  __spreadValues({
    path: "",
    loadChildren: () => import("./chunk-2RK5SJTU.js").then((m) => m.home)
  }, false ? { \u0275entryName: "src/app/components/home/home.routes.ts" } : {}),
  __spreadValues({
    path: "account",
    loadChildren: () => import("./chunk-26WXJYR6.js").then((m) => m.account),
    canActivate: [AuthGuard]
  }, false ? { \u0275entryName: "src/app/components/account/account.routes.ts" } : {}),
  __spreadValues({
    path: "",
    loadChildren: () => import("./chunk-N2JGIS7R.js").then((m) => m.shop)
  }, false ? { \u0275entryName: "src/app/components/shop/shop.routes.ts" } : {}),
  __spreadValues({
    path: "",
    loadChildren: () => import("./chunk-YUUAIEEZ.js").then((m) => m.page)
...
var routes = [
  ...
  __spreadValues({
    path: "",
    loadComponent: () => import("./chunk-6U4M6FAX.js").then((m) => m.Layout),
    children: content
...
var AuthInterceptor = class _AuthInterceptor {
  ...
  intercept(req, next) {
    ...
    const isPublic = this.publicEndpoints.some((endpoint) => req.url.toLowerCase().includes(endpoint.toLowerCase()));
