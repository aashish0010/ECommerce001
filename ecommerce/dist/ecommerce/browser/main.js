...
import {
  AuthState
} from "./chunk-L6NFQK45.js";
import {
  CountryState,
  GetCountriesAction,
  GetStatesAction,
  StateState
} from "./chunk-IORHNUXK.js";
import {
  ColorState
} from "./chunk-TKFREGUT.js";
import {
  PointState
} from "./chunk-HXIEBDW4.js";
import {
  OrderStatusState
...
import "./chunk-VVQLAKFR.js";
import {
  DownloadState
} from "./chunk-S66W4B3A.js";
import {
  RefundState
} from "./chunk-JP4RVPJE.js";
import "./chunk-UTLPXFOE.js";
import {
  GetThemesAction,
  ThemeState
} from "./chunk-ZFPNMPHS.js";
import {
  BlogState
} from "./chunk-SIZ4ZBMI.js";
import {
  CouponState
} from "./chunk-TCV265KK.js";
import {
  AttributeState
...
import {
  NotificationState
} from "./chunk-UBWDSGQK.js";
import {
  PaymentDetailsState
} from "./chunk-HAGOJ5CX.js";
import {
...
var App = class _App {
    ...
    if (this.isBrowser) {
      this.themeOption$.subscribe((theme) => {
        ...
        if (theme?.general?.mode === "dark") {
          document2.body.classList.add(theme?.general && theme?.general?.mode);
        } else {
          document2.body.classList.remove("dark");
        }
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _App, selectors: [["app-root"]], decls: 1, vars: 0, template: function App_Template(rf, ctx) {
      if (rf & 1) {
...
var content = [
  __spreadValues({
    path: "",
    loadChildren: () => import("./chunk-UGFAB2CM.js").then((m) => m.home)
  }, false ? { \u0275entryName: "src/app/components/home/home.routes.ts" } : {}),
  __spreadValues({
    path: "account",
    loadChildren: () => import("./chunk-YZOQ5TTF.js").then((m) => m.account),
    canActivate: [AuthGuard]
  }, false ? { \u0275entryName: "src/app/components/account/account.routes.ts" } : {}),
  __spreadValues({
    path: "",
    loadChildren: () => import("./chunk-7GX6G3DI.js").then((m) => m.shop)
  }, false ? { \u0275entryName: "src/app/components/shop/shop.routes.ts" } : {}),
  __spreadValues({
    path: "",
    loadChildren: () => import("./chunk-ZKDVM6X2.js").then((m) => m.page)
  }, false ? { \u0275entryName: "src/app/components/page/page.routes.ts" } : {}),
  __spreadValues({
    path: "**",
    pathMatch: "full",
...
var routes = [
  ...
  __spreadValues({
    path: "",
    loadComponent: () => import("./chunk-NISO7OSI.js").then((m) => m.Layout),
    children: content
  }, false ? { \u0275entryName: "src/app/layout/layout.ts" } : {})
];
...
var ErrorService = class _ErrorService {
  ...
  static {
    this.\u0275fac = function ErrorService_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _ErrorService)();
    };
  }
  static {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ErrorService, [{
    type: Injectable,
    args: [{
      providedIn: "root"
    }]
...
var LoggingService = class _LoggingService {
  ...
  static {
    this.\u0275fac = function LoggingService_Factory(__ngFactoryType__) {
...
// src/app/core/interceptors/global-error-handler.interceptor.ts
var GlobalErrorHandlerInterceptor = class _GlobalErrorHandlerInterceptor {
  constructor() {
    this.errorService = inject(ErrorService);
    this.logger = inject(LoggingService);
    this.notifier = inject(NotificationService);
  }
  intercept(request, next) {
    return next.handle(request).pipe(catchError((error) => {
      ...
      if (error.error instanceof SyntaxError) {
        errorMessage = "Server temporarily unavailable. Please refresh the page.";
      } else {
        errorMessage = this.errorService.getClientErrorMessage(error.error);
      }
  ...
  static {
    this.\u0275fac = function GlobalErrorHandlerInterceptor_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _GlobalErrorHandlerInterceptor)();
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _GlobalErrorHandlerInterceptor, factory: _GlobalErrorHandlerInterceptor.\u0275fac });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(GlobalErrorHandlerInterceptor, [{
    type: Injectable
  }], null, null);
})();
...
var LoaderInterceptor = class _LoaderInterceptor {
  ...
  static {
    this.\u0275fac = function LoaderInterceptor_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _LoaderInterceptor)();
    };
  }
  static {
...
var GetStoreBySlugAction = class {
  static {
...
var StoreState = class StoreState2 {
  ...
  static {
    this.\u0275fac = function StoreState_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || StoreState2)();
    };
  }
  static {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(StoreState, [{
    type: Injectable
  }], null, { getStores: [], getStoreBySlug: [] });
})();

// src/app/shared/store/state/subscription.state.ts
var SubscriptionState = class _SubscriptionState {
  ...
  static {
    this.\u0275fac = function SubscriptionState_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _SubscriptionState)();
    };
  }
  static {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(SubscriptionState, [{
    type: Injectable
  }], () => [], { create: [] });
})();
...
var TagService = class _TagService {
  ...
  getTags(payload) {
    return this.http.get(`${environment.URL}/tag.json`, { params: payload });
  }
  static {
    this.\u0275fac = function TagService_Factory(__ngFactoryType__) {
...
// src/app/shared/store/action/tag.action.ts
var GetTagsAction = class {
  static {
    this.type = "[Tag] Get";
  }
  constructor(payload) {
...
// src/app/shared/store/state/tag.state.ts
var TagState = class TagState2 {
  ...
  static {
    this.\u0275fac = function TagState_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || TagState2)();
    };
  }
  static {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(TagState, [{
    type: Injectable
  }], null, { getTags: [] });
})();
...
var appConfig = {
  providers: [
    ...
    //   multi: true,
    // },
    importProvidersFrom(BrowserModule, BrowserAnimationsModule, CarouselModule, LoadingBarRouterModule, ToastrModule.forRoot({
      ...
      WalletState,
      WishlistState
    ]), NgxsModule.forFeature([AuthState]), RouterModule.forRoot(routes, {
