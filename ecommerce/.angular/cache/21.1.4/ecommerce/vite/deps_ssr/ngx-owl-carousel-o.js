...
var NavigationService = class _NavigationService {
   ...
   */
  spyDataStreams() {
    const initializedCarousel$ = this.carouselService.getInitializedState().pipe((0, import_operators.tap)((state) => {
      this.initialize();
...
var AutoHeightService = class _AutoHeightService {
  ...
  spyDataStreams() {
    ...
    const autoHeight$ = (0, import_rxjs.merge)(initializedCarousel$, changedSettings$, refreshedCarousel$).pipe((0, import_operators.tap)(() => {
