...
namespace ECommerceApp.Service.Services
{
    public class ProductService : IProductService
    {
        ...
        public virtual async Task<ProductResponseDto> GetProducts(int companyInfoId, int? categoryId, string categorySlug, string search, int page, int pageSize, int? brandId = null, string brandSlug = null, string colorSlugs = null, string subcategorySlugs = null, bool topSelling = false)
        {
        ...
        public virtual async Task<SingleProductResponseDto> GetProductBySlug(string slug)
        {
        ...
        public virtual async Task<SingleProductResponseDto> CreateProduct(CreateProductRequest request)
        {
        ...
        public virtual async Task<SingleProductResponseDto> UpdateProduct(int id, UpdateProductRequest request)
        {
        ...
        public virtual async Task<SingleProductResponseDto> UpdateProductStatus(int id, bool status)
        {
        ...
        public virtual async Task<SingleProductResponseDto> DeleteProduct(int id)
        {
            var product = await _context.Products
                .Include(p => p.ProductColors)
                .FirstOrDefaultAsync(p => p.Id == id);
        ...
        public virtual async Task<ProductResponseDto> DeleteAllProducts(List<int> ids)
        {
        ...
        public virtual async Task<CategoryResponseDto> SeedCategories(int companyInfoId)
        {
            try
            {
