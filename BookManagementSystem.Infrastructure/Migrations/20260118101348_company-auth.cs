...
{
    /// <inheritdoc />
    public partial class companyauth : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyPhoneNumber = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    CompanyEmail = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    OperationsDate = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ThirdPartyId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SocialMediaName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    SocialMediaLink = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SocialMediaDesc = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    CompanyInfoId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
